/*
 ...
 Name:          seg_all_csv_tab_part.sql

 Purpose:       Partitioned segment details as a csv file for loading to spreadsheet
 ...
 21st Apr 2015   Aidan Lawrence  Partitioned Tables separated out for easier reporting 
...
set heading off
set termout off
define script_name = 'seg_all_csv_tab_part'
--
...
select 'owner, partition_name, tablespace_name, table_name, seg_bytes, extents, num_rows, avg_row_len, allocated_blocks, actual_blocks, calc_blocks,pctfree, last_analyzed'
from dual
/
...
|| ',' ||  to_char(tab.last_analyzed,'DD-MON-YYYY') --last_analyzed  seg_part_csv
...
and   tab.table_owner not in &ignore_schemas
