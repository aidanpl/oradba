/*
 ...
 Name:          tbsp_stats_dbarep_schedule.sql

 Purpose:       schedule for tbsp_stats within dbarep 
...
BEGIN
	...
	BEGIN
        ...
        schedule_name            => 'TBSP_STATS_DBAREP_SCH'
		);
...
dbms_scheduler.create_schedule(
  ...
  , repeat_interval     => 'FREQ=WEEKLY; BYDAY=SUN; BYHOUR=09; BYMINUTE=00; BYSECOND=00;'
  , end_date            => to_timestamp('31-DEC-2099 0:00','DD-MON-YYYY HH24:MI')
  , comments            => 'Schedule to populate tbsp_stats for all monitored databases'
    );
