/*
 ...
 Name:          cr_app_users_pw_11g.sql

 Purpose:       Generate User creation with original pw - version specific - 11g onwards 
 
 Usage:			Schema creation in a new database 
 
 Example:       sqlplus -s user/pw@sid @cr_app_users_pw_11g.sql
...
define script_name = 'cr_app_users_pw_11g'
