/*
 ...
 Name:          dbms_stats_schema_unlock.sql

 Purpose:       Unlock stats at a schema level 
 
 Usage:			Schema stats management
                
 Example:       sqlplus -s sys/pw@sid as sysdba @dbms_stats_schema_unlock <schema_name>

                sqlplus -s sys/pw@sid as sysdba @dbms_stats_schema_unlock HR
...
define script_name = 'dbms_stats_schema_unlock'
set verify on
...
v_schema_name := '&schema_name';
   ...
   dbms_stats.unlock_schema_stats(
         ownname=> v_schema_name   -- Schema to unlock
     );
