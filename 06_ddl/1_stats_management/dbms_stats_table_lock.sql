/*
 ...
 Name:          dbms_stats_table_lock.sql

 Purpose:       Unlock stats at a table level 
 
 Usage:			Unlock stats for a single table 
                
 Example:        Example:       sqlplus -s sys/pw@sid as sysdba @dbms_stats_schema_lock <schema_name> <table_name>

                sqlplus -s sys/pw@sid as sysdba @dbms_stats_schema_lock HR EMPLOYEES
...
define script_name = 'dbms_stats_table_lock'
set verify on
