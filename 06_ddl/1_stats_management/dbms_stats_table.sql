/*
 ...
 Name:          dbms_stats_table.sql

 Purpose:       Refresh/rebuild stats at a table level

 Usage:

 Example:       sqlplus -s user/pw@sid @dbms_stats_table <schema_name> <table_name>

                sqlplus sh/<pw>@sid @dbms_stats_table SH COUNTRIES
...
define script_name = 'dbms_stats_table'
set verify on
